...
// with fixes
const exasol::udf::v2::third_party::nlohmann::json patch_schema = R"patch({
...
void json_patch::validateJsonPatch(json const &patch)
{
	...
	static exasol::udf::v2::third_party::nlohmann::json_schema::json_validator patch_validator(patch_schema);
